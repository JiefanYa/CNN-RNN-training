...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        b, hidden_cache = affine_relu_forward(a, W2, b2)
        scores, final_cache = affine_forward(b, W3, b3)
        ...
        db, grads['W3'], grads['b3'] = affine_backward(dscores, final_cache)
        da, grads['W2'], grads['b2'] = affine_relu_backward(db, hidden_cache)
